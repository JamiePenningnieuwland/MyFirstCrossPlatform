...
bool    ImGui_ImplX11_Init(void* display, void* window)
{
    ...
    ////////////////////////////changed these codes where wrong
    io.KeyMap[ImGuiKey_Tab] = 9;//XK_Tab - 0xFF00;
    io.KeyMap[ImGuiKey_LeftArrow] = 81;//XK_Left - 0xFF00;
    io.KeyMap[ImGuiKey_RightArrow] = 83;// XK_Right - 0xFF00;

    //io.KeyMap[ImGuiKey_UpArrow] = XK_Up - 0xFF00;
    //io.KeyMap[ImGuiKey_DownArrow] = XK_Down - 0xFF00;
    //io.KeyMap[ImGuiKey_PageUp] = XK_Prior - 0xFF00;
    //io.KeyMap[ImGuiKey_PageDown] = XK_Next - 0xFF00;
  ...
  //  io.KeyMap[ImGuiKey_Insert] = XK_Insert - 0xFF00;
   // io.KeyMap[ImGuiKey_Delete] = XK_Delete - 0xFF00;
    io.KeyMap[ImGuiKey_Backspace] = 8;// XK_BackSpace - 0xFF00;

  //  io.KeyMap[ImGuiKey_Space] = XK_space - 0xFF00;
...
IMGUI_IMPL_API int ImGui_ImplX11_EventHandler(XEvent& event)
{
    ...
    case KeyPress:
    {
        int key = XkbKeycodeToKeysym(g_Display, static_cast<unsigned char>(event.xkey.keycode), 0, event.xkey.state & ShiftMask ? 1 : 0);
        if (key < 255)
        {
